...
import com.example.administrator.myapplication.wheelHYH.adapters.WheelViewAdapter;
...
public class WheelView extends View {
    ...
    private int[] SHADOWS_COLORS = new int[] { 0xFFFFFFFF,0xAAFFFFFF, 0x77FFFFFF};
    ...
    private int wheelBackground = 0xFFFFFFFF;
	...
	private int mColorLine = 0xffff0000;

	private float mCenterRectOffset = 0.1f;
	...
	public void setColorLine(int lineColor){
		mColorLine = this.getContext().getResources().getColor(lineColor);
	}
	...
	private void drawShadows(Canvas canvas) {
        ...
        int offset = getItemHeight() / 2 + (int)(getItemHeight() * mCenterRectOffset);
		topShadow.setBounds(0, 0, getWidth(), center - offset);
		topShadow.draw(canvas);

		bottomShadow.setBounds(0, center + offset, getWidth(), getHeight());
	...
	private void doScroll(int delta) {
		viewAdapter.setCurrentCenterIndex(currentItem);
